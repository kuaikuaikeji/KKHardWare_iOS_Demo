...
[KKBLECentralManager](Doc/KKBLECentralManage)：蓝牙中央管理器，管理蓝牙外设状态。

[KKBLEArmBandPeripheral](Doc/KKBLEArmBandPeripheral)：蓝牙臂带外设，封装了臂带功能。

[KKBLEHealthScalePeripheral](Doc/KKBLEHealthScalePeripheral)：蓝牙体脂秤外设，封装了体脂称功能。

[KKBLEPeripheralDFUManager](Doc/KKBLEPeripheralDFUManager)：DFU管理器，管理外设固件升级。
